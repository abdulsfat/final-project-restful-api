...
// TODO 1: END
  ...
  async active(req, res) {
    try {
      ...
      if (employees.some((employee) => employee.status === "active")) {
        const data = {
          message: "The request succeeded",
          data: employees,
        };
  ...
  async inactive(req, res) {
    try {
      ...
      if (employees.some((employee) => employee.status === "inactive")) {
        const data = {
          message: "The request succeeded",
          data: employees,
        };
  ...
  async terminated(req, res) {
    try {
      ...
      if (employees.some((employee) => employee.status === "terminated")) {
        const data = {
          message: "The request succeeded",
          data: employees,
        };
